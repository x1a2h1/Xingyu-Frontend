...
export function fetchCreateRole(
  data: Omit<Api.Role.Info, "id" | "create_time" | "update_time">,
) {
...
export function fetchUpdateRole(
  id: number,
  data: Partial<Omit<Api.Role.Info, "id" | "create_time" | "update_time">>,
) {
  return request<Api.Role.Info>({
    data,
    method: "put",
...
/** 更新角色菜单权限 */
export function fetchUpdateRoleMenu(
  id: number,
  data: { menu_ids: React.Key[] },
) {
  return request<null>({
    data,
    method: "put",
...
/** 更新角色按钮权限 */
export function fetchUpdateRoleButtons(
  id: number,
  data: { button_codes: React.Key[] },
) {
  return request<null>({
    data,
    method: "put",
